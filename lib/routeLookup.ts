...
export const ROUTE_LOOKUP: LookupEntry[] = [
  ...
  {
    id: "bay-direct",
    chokepointId: "bay_bengal_cyclone",
    originLabel: "Colombo",
    destLabel: "Chittagong",
    originCoords: [79.87, 6.93],
    destCoords: [91.83, 22.33],
    cameraZoom: 4.0,
    cameraCenter: [86, 14],
    complianceProfileIds: ["india_eez_west"],
    directRoute: {
      id: "bay-direct",
      label: "Colombo -> Bay of Bengal -> Chittagong (Hazardous)",
      waypoints: [[79.87,6.93],[79.0,6.0],[79.0,5.5],[81.5,5.5],[83.0,7.0],[84.5,9.0],[85.5,11.0],[87.0,13.5],[89.5,18.5],[90.5,20.5],[91.83,22.33]],
      distanceNm: 1385,
      etaHours: 77,
    },
    safeRoute: {
      id: "bay-northern-bypass",
      label: "Colombo -> Northern Coastal Bypass -> Chittagong",
      waypoints: [[79.87,6.93],[79.0,6.0],[79.0,5.5],[81.5,5.5],[83.0,7.0],[83.5,9.0],[83.0,11.5],[82.5,13.5],[83.5,16.0],[84.5,18.0],[87.0,20.5],[90.5,21.5],[91.83,22.33]],
      distanceNm: 1595,
      etaHours: 89,
    },
  },
...
export const CHOKEPOINT_META: Record<string, ChokepointMeta> = {
  ...
  bay_bengal_cyclone: {
    id: "bay_bengal_cyclone",
    label: "Bay of Bengal — Cyclone Zone",
    region: "Bay of Bengal",
    defaultZoneIds: ["bay_bengal_cyclone"],
    statusTemplate: (s) =>
      `Category ${s >= 5 ? 5 : s >= 4 ? 4 : 3} cyclone active. Severity ${s}. ${s >= 5 ? "140 kt sustained winds. 9.2 m wave height. All transits suspended." : "Extreme weather conditions. Immediate diversion advised."}`,
    transitDelayHours: (s) => s * 20,
  },
};
