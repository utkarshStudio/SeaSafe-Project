...
export const DANGER_ZONES: DangerZone[] = [
  ...
  },
  {
    ...
    label: "Bay of Bengal — Cyclone Asha Category 5",
    type: "weather",
    severity: 5,
    polygon: [
      [83.5, 10.0],
    ...
    description:
      "Cyclone Asha (Cat 5): 140 kt sustained winds, 945 mb central pressure, 9.2 m sig. wave height. All direct transits suspended.",
    fillColor: [126, 34, 206, 65],
    lineColor: [248, 113, 113, 220],
  },
];
